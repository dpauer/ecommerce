    ...
    <>
      ...
      <PageHeader
        ...
        extra={
          <HSpace>
            ...
            <DeleteButton
              url={route(
                "dashboard.categories.attributes.attribute-values.destroy",
                {
                  category,
                  attribute,
                  attributeValue,
      ...
      <DetailsCard>
        <Row>
          ...
          <Col>
            <DetailItem label="Value:" value={attributeValue.value} />
          </Col>
        </Row>
        <Row>
          <Col>
            <DetailItem label="Created At:" value={attributeValue.created_at} />
          </Col>
          <Col>
            <DetailItem label="Updated At:" value={attributeValue.updated_at} />
          </Col>
        </Row>
      </DetailsCard>
    </>
